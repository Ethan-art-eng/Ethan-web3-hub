...
const SECURITY_HEADERS = {
  "content-security-policy": "default-src 'self'; script-src 'self' https://challenges.cloudflare.com https://accounts.google.com/gsi/client; style-src 'self'; img-src 'self' data: https://www.google.com https://*.googleusercontent.com https://*.videodelivery.net https://*.cloudflarestream.com; connect-src 'self' https://upload.videodelivery.net https://challenges.cloudflare.com https://accounts.google.com/gsi/; frame-src https://iframe.videodelivery.net https://*.cloudflarestream.com https://challenges.cloudflare.com https://accounts.google.com/gsi/ https://www.youtube-nocookie.com https://player.vimeo.com https://player.bilibili.com https://v.qq.com https://player.youku.com; object-src 'none'; base-uri 'self'; form-action 'self' https://upload.videodelivery.net; frame-ancestors 'none'; upgrade-insecure-requests",
